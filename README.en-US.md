...
After pushing a version tag, GitHub Actions will build six sets of desktop artifacts (Windows x64/ARM64, macOS Intel/Apple Silicon, and Linux x64/ARM64) and automatically create a Release:
