...
- 文字水印：原生读取系统字体或导入字体文件，支持角度、字号、透明度、0–100% 非线性铺设密度、自由位置和阴影
...
- 右下角磨砂悬浮结果：桌宠 / 紧凑 / 完整三种入口，可点击选图或拖放，支持预览、画质、尺寸、回撤、定位、复制压缩文件与定时收起
...
标准系统托盘 API 在 Windows、macOS 和 Linux 上没有统一的文件拖放事件，因此 PicLite 使用托盘菜单唤起一个无任务栏图标、始终置顶的磨砂“悬浮压缩坞”。桌宠入口既可点击选图，也可接收拖放；压缩完成或文件夹监测产生结果后，会在当前屏幕右下角展开结果卡片。画质与尺寸每次都从原图重算，支持回撤、预览、复制压缩文件、定位文件，并可设置 0–120 秒后自动收起。
