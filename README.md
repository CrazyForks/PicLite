...
- 右下角悬浮结果：紧凑 / 完整两种样式；压缩完成、剪贴板监听或文件夹监测产生结果后可继续调整参数、预览、复制和定位文件
...
推送版本标签后，GitHub Actions 会构建六组桌面产物（Windows x64/ARM64、macOS Intel/Apple Silicon、Linux x64/ARM64），并自动创建 Release：
